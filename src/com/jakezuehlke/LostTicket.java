...
public class LostTicket implements Ticket
{
     ...
     * Additionally, a TicketType enum value (in this case, LOST) is also used to build the ParkingBill.
     */
    public LostTicket()
    {
        ...
        this.parkingBill =
            new ParkingBill(TicketType.LOST, checkInTime.getCheckInTime(), checkInTime.getCheckInTime());
    }
